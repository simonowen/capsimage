...
IF(CAPSIMAGE_VERSION_HEADER)
	...
	IF(ADD_INCLUDE_SUFFIX)
		SET(CapsImage_INCLUDE_PATH_SUFFIX "${CAPSIMAGE_VERSION}")
	ENDIF()
ELSEIF(CAPSIMAGE_VERSION_HINTS)
	string(REGEX REPLACE "^([0-9]+).([0-9]+)$" "\\1" CAPSIMAGE_VERSION_RELEASE "${CAPSIMAGE_VERSION_RELEASE_LINE")
	string(REGEX REPLACE "^([0-9]+).([0-9]+)$" "\\2"  CAPSIMAGE_VERSION_REVISION "${CAPSIMAGE_VERSION_REVISION_LINE")
	SET(CAPSIMAGE_VERSION ${CAPSIMAGE_VERSION_RELEASE}.${CAPSIMAGE_VERSION_REVISION})
	SET(CAPSIMAGE_VERSION_STRING "${CAPSIMAGE_VERSION}")
	IF(ADD_INCLUDE_SUFFIX)
		SET(CapsImage_INCLUDE_PATH_SUFFIX "${CAPSIMAGE_VERSION}")
